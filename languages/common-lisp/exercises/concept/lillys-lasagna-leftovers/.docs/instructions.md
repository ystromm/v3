...
(remaining-minutes-in-oven 'very-short) ;; => 237
...
*a lot of lasanga*! Lilly wants to repay you for all your help by
...
both agree that it would be great if the function could just *assume*
...
function should return `'just-split-it`. *However* if the weight is
